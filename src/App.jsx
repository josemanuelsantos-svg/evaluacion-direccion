...
const defaultSurveyData = {
  director_general: {
    ...
    iconName: 'Briefcase',
    description:
      'Evaluación del liderazgo, capacidad de resolución y trato humano en la dirección del centro.',
    ...
    sections: [
      {
        ...
        questions: [
          {
            id: 'dg_1',
            text: 'Siento que transmite una visión clara y motivadora que da sentido a mi trabajo diario.',
          },
          {
            id: 'dg_2',
            text: 'Ante imprevistos o crisis, gestiona la situación con seguridad, eficacia y tranquilidad.',
          },
          {
            id: 'dg_3',
            text: 'Toma decisiones organizativas ágiles que realmente mejoran el funcionamiento del centro.',
          },
          {
            id: 'dg_4',
            text: 'Me siento impulsado/a por la dirección para innovar, formarme y mejorar continuamente en mi labor.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'dg_5',
            text: 'En mi trato personal con él/ella, percibo cercanía, respeto y empatía hacia mis circunstancias.',
          },
          {
            id: 'dg_6',
            text: 'Siento que mi esfuerzo diario y mis aportaciones son valoradas y reconocidas activamente.',
          },
          {
            id: 'dg_7',
            text: 'Cuando surgen conflictos, interviene de manera justa, escuchando a todas las partes y buscando soluciones.',
          },
          {
            id: 'dg_8',
            text: 'Muestra coherencia personal entre los valores que predica el centro y sus decisiones diarias.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'dg_9',
            text: 'Me resulta fácil acceder a él/ella cuando necesito plantear una inquietud o propuesta importante.',
          },
          {
            id: 'dg_10',
            text: 'La comunicación institucional (reuniones, circulares) es clara, transparente y llega a tiempo.',
          },
          {
            id: 'dg_11',
            text: 'Escucha activamente las críticas constructivas y demuestra voluntad de cambiar lo que no funciona.',
          },
          {
            id: 'dg_12',
            text: 'Defiende y representa con eficacia los intereses de los trabajadores y del colegio hacia el exterior.',
          },
        ],
      },
    ],
  ...
  director_pedagogico: {
    ...
    description:
      'Evaluación del apoyo diario en el aula, resolución de problemas académicos y trato al docente.',
    ...
    sections: [
      {
        ...
        questions: [
          {
            id: 'dp_1',
            text: 'Resuelve con agilidad y eficacia los problemas organizativos diarios (horarios, sustituciones, guardias).',
          },
          {
            id: 'dp_2',
            text: 'Sus orientaciones pedagógicas me resultan útiles, realistas y aplicables en mi día a día en el aula.',
          },
          {
            id: 'dp_3',
            text: 'Coordina de forma eficiente la atención a la diversidad, dando respuestas ágiles a las necesidades de mis alumnos.',
          },
          {
            id: 'dp_4',
            text: 'Sabe dinamizar las reuniones de claustro/departamento para que sean realmente productivas y no una pérdida de tiempo.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'dp_5',
            text: 'Siento que se preocupa genuinamente por mi bienestar profesional y me ofrece un trato comprensivo.',
          },
          {
            id: 'dp_6',
            text: 'Me apoya de manera efectiva y me da facilidades cuando propongo nuevas iniciativas para mis clases.',
          },
          {
            id: 'dp_7',
            text: 'Cuando cometo un error o tengo una dificultad, su corrección es constructiva, respetuosa y orientada a la mejora.',
          },
          {
            id: 'dp_8',
            text: 'No delega en exceso; asume su responsabilidad y se implica a mi lado cuando hay sobrecarga de trabajo.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'dp_9',
            text: 'Me siento plenamente respaldado/a por la dirección pedagógica cuando trato con familias en situaciones difíciles.',
          },
          {
            id: 'dp_10',
            text: 'Interviene con eficacia, firmeza y rapidez ante problemas graves de disciplina o convivencia en mis clases.',
          },
          {
            id: 'dp_11',
            text: 'Transmite confianza, tacto y profesionalidad en su trato directo con el alumnado y las familias.',
          },
          {
            id: 'dp_12',
            text: 'Aplica las normas de convivencia del centro de forma justa, equitativa y sin favoritismos.',
          },
        ],
      },
    ],
  ...
  coordinador_pastoral: {
    ...
    description:
      'Evaluación del acompañamiento humano, eficacia en la dinamización de actividades y cercanía.',
    requiresSubRole: false,
    sections: [
      {
        ...
        questions: [
          {
            id: 'cp_1',
            text: 'Organiza las actividades pastorales y solidarias con eficacia, anticipación y claridad en las indicaciones.',
          },
          {
            id: 'cp_2',
            text: 'Me facilita materiales, tiempos y recursos prácticos que me resultan realmente útiles para trabajar en mis clases.',
          },
          {
            id: 'cp_3',
            text: 'Las celebraciones o momentos de reflexión que propone logran conectar con la realidad y motivar al alumnado.',
          },
          {
            id: 'cp_4',
            text: 'Consigue involucrar al claustro en la acción pastoral sin que esto suponga una carga burocrática excesiva o desorganizada.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'cp_5',
            text: 'En mi vivencia personal, es una figura acogedora, que transmite paz, alegría y sabe escuchar sin juzgar.',
          },
          {
            id: 'cp_6',
            text: 'Sé con certeza que puedo acudir a él/ella en un momento de dificultad personal y recibiré un acompañamiento sincero.',
          },
          {
            id: 'cp_7',
            text: 'Trata a todos los miembros de la comunidad con exquisito respeto, independientemente de sus creencias o nivel de implicación.',
          },
          {
            id: 'cp_8',
            text: 'Siento su apoyo directo, cercano y cálido cuando mi tutoría atraviesa un momento delicado a nivel humano.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'cp_9',
            text: 'Comunica el ideario y los valores del centro de una forma inspiradora, actual y alejada de rutinas vacías.',
          },
          {
            id: 'cp_10',
            text: 'Gestiona con eficacia los proyectos de voluntariado, logrando un impacto real y formativo en quienes participan.',
          },
          {
            id: 'cp_11',
            text: 'Consigue despertar la sensibilidad y el espíritu crítico y solidario frente a las injusticias sociales.',
          },
          {
            id: 'cp_12',
            text: 'Su presencia y labor diaria hacen que el colegio se perciba verdaderamente como una comunidad unida y humana.',
          },
        ],
      },
    ],
  ...
  administrador: {
    ...
    iconName: 'Building',
    description:
      'Evaluación del mantenimiento de instalaciones, agilidad en reparaciones y trato humano.',
    requiresSubRole: false,
    sections: [
      {
        ...
        questions: [
          {
            id: 'ad_1',
            text: 'Mantiene las instalaciones en óptimo estado, garantizando que mi espacio de trabajo sea seguro, limpio y confortable.',
          },
          {
            id: 'ad_2',
            text: 'Asegura que los espacios comunes (patios, pasillos, aseos, zonas de profesores) sean funcionales y presenten un aspecto cuidado.',
          },
          {
            id: 'ad_3',
            text: 'Supervisa de forma efectiva los servicios generales (limpieza, portería, mantenimiento) asegurando su buen funcionamiento diario.',
          },
          {
            id: 'ad_4',
            text: 'Garantiza que el centro cumple con las medidas de seguridad, evacuación y prevención de riesgos necesarias.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'ad_5',
            text: 'Cuando reporto una avería o necesito una reparación urgente en mi aula, se actúa y resuelve con rapidez y eficacia.',
          },
          {
            id: 'ad_6',
            text: 'En mi trato directo con él/ella, recibo siempre una atención amable, cercana, paciente y respetuosa.',
          },
          {
            id: 'ad_7',
            text: 'Se muestra accesible y receptivo/a cuando necesito plantear una necesidad material extraordinaria para un proyecto de clase.',
          },
          {
            id: 'ad_8',
            text: 'Su forma de comunicar las normativas de uso de espacios o limitaciones de recursos es asertiva y razonada.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'ad_9',
            text: 'Gestiona las peticiones de material o mobiliario de manera diligente, intentando dar siempre la mejor solución posible.',
          },
          {
            id: 'ad_10',
            text: 'Coordina al personal a su cargo fomentando un clima de eficiencia, respeto y buen trato hacia la comunidad educativa.',
          },
          {
            id: 'ad_11',
            text: 'Demuestra disposición para escuchar sugerencias del personal sobre cómo mejorar la funcionalidad o estética del centro.',
          },
          {
            id: 'ad_12',
            text: 'Implementa mejoras y reformas en las infraestructuras que realmente impactan positivamente en nuestra comodidad diaria.',
          },
        ],
      },
    ],
...
export default function App() {
  ...
  const getProgress = () => {
    ...
    const totalQuestions = roleData.sections.reduce(
  ...
  const fetchAdminData = async () => {
    ...
    try {
      const q = query(
        collection(db, 'evaluaciones_directivos'),
  ...
  const calculateStats = (roleKey, profileFilter) => {
    ...
    const evals = allEvaluations.filter(
      (e) =>
        ...
        (profileFilter !== 'todos'
          ? e.evaluatorProfile === profileFilter
          : true)
    );
      ...
      section.questions.forEach((q) => {
        evals.forEach((e) => {
          ...
          if (val && val > 0) {
            ...
            totalScoreSum += val;
            totalValidAnswers++;
            stats.scoreDistribution[val] =
              (stats.scoreDistribution[val] || 0) + 1;
          }
        });
      });
    ...
    stats.globalAverage =
      totalValidAnswers > 0 ? totalScoreSum / totalValidAnswers : 0;

    if (stats.sectionAverages.length > 0) {
      stats.highestSection = stats.sectionAverages.reduce(
        (max, s) => (s.average > max.average ? s : max),
        stats.sectionAverages[0]
      );
      stats.lowestSection = stats.sectionAverages.reduce(
        (min, s) => (s.average < min.average ? s : min),
        stats.sectionAverages[0]
      );
    }
  ...
  const exportToCSV = () => {
    ...
    let csvContent =
      'ID,Fecha,Rol Evaluado,Subrol,Perfil Evaluador,Puntuacion Media,Comentarios\n';
    ...
    allEvaluations.forEach((ev) => {
      ...
      const comment = ev.comments
        ? `"${ev.comments.replace(/"/g, '""').replace(/\n/g, ' ')}"`
        : 'Ninguno';
    ...
    try {
      ...
      link.setAttribute(
        'download',
        `auditoria_360_${new Date().toISOString().split('T')[0]}.csv`
      );
  ...
  const handleQuestionTextChange = (
    ...
    setLocalSurveyConfig((prev) => {
      ...
      next[roleKey] = {
        ...next[roleKey],
        sections: [...next[roleKey].sections],
      };
      next[roleKey].sections[sectionIndex] = {
        ...next[roleKey].sections[sectionIndex],
        questions: [...next[roleKey].sections[sectionIndex].questions],
      };
  ...
  const handleAddQuestion = (roleKey, sectionIndex) => {
    const newId = `${roleKey}_q_${Date.now()
      .toString()
      .slice(-6)}_${Math.random().toString(36).substr(2, 4)}`;
    setLocalSurveyConfig((prev) => {
      const next = { ...prev };
      next[roleKey] = {
        ...next[roleKey],
      ...
      next[roleKey].sections[sectionIndex].questions.push({
        id: newId,
        text: '',
      });
      return next;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm hidden sm:block">
                Auditoría de Calidad Institucional
              </p>
            </div>
          </div>
      ...
      <main className="max-w-6xl mx-auto py-8 px-4 md:px-8">
          ...
          <div className="animate-fade-in max-w-5xl mx-auto">
            <div className="mb-8 text-center md:text-left">
              ...
              <p className="text-slate-600 max-w-3xl">
                Valore la gestión de los directivos basándose en su vivencia
                personal, su eficacia diaria y el trato recibido. Sus respuestas
                son completamente anónimas y vitales para la mejora continua del
                centro.
              </p>
            </div>
        ...
        {currentView === 'profile_selection' && selectedRole && (
          <div className="animate-fade-in max-w-5xl mx-auto">
            ...
            <div className="mb-8 text-center md:text-left">
              <h2 className="text-2xl font-bold text-slate-800 mb-2">
                ¿Desde qué perspectiva evalúa?
              </h2>
              <p className="text-slate-600 max-w-3xl">
                Para garantizar un análisis 360º riguroso, necesitamos conocer
                su rol dentro de la comunidad educativa.
                <span className="font-bold text-blue-600">
                  {' '}
                  Este dato es vital y 100% anónimo.
                </span>
              </p>
            </div>
        ...
        {currentView === 'subrole_selection' &&
          selectedRole &&
          surveyConfig[selectedRole].requiresSubRole && (
            <div className="animate-fade-in max-w-5xl mx-auto">
              <button
              ...
              <div className="mb-8 text-center md:text-left">
                <h2 className="text-2xl font-bold text-slate-800 mb-2">
                  Seleccione la Etapa Educativa
                </h2>
                <p className="text-slate-600 max-w-3xl">
                  Para la figura de {surveyConfig[selectedRole].title}, por
                  favor indique con qué etapa interactúa en su día a día.
                </p>
              </div>
          ...
          <div className="animate-fade-in max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6">
              <div className="bg-blue-600 p-6 text-white flex items-center gap-4">
                {React.createElement(
                  iconMap[surveyConfig[selectedRole].iconName] || ClipboardList,
                ...
                <div>
                  <h2 className="text-2xl font-bold flex items-center gap-2">
                    ...
                    {selectedSubRole && (
                      <span className="text-blue-200 text-lg font-normal">
                        |{' '}
                        {
                          surveyConfig[selectedRole].subRoles.find(
                            (sr) => sr.id === selectedSubRole
                          )?.title
                        }
                      </span>
                    )}
                  ...
                  <p className="text-blue-100 text-sm mt-1">
                    Evaluando desde la perspectiva de:{' '}
                    <span className="font-semibold text-white">
                      {
                        evaluatorProfiles.find((p) => p.id === evaluatorProfile)
                          ?.label
                      }
                    </span>
                  </p>
                ...
                <div className="m-6 p-4 bg-red-50 border-l-4 border-red-500 flex items-start gap-3 rounded-r">
                  ...
                  <div>
                    ...
                    <p className="text-red-700 text-sm mt-1">
                      Por favor, responda a todas las preguntas para poder
                      procesar la evaluación. Faltan {getUnansweredCount()}{' '}
                      preguntas.
                    </p>
                  </div>
                </div>
              ...
              <div className="p-6 md:p-8 space-y-10">
                ...
                <div className="space-y-4 pt-6 border-t border-slate-200">
                  ...
                  <p className="text-sm text-slate-500">
                    Sientase libre de detallar situaciones concretas, propuestas
                    de mejora o aspectos que valora muy positivamente de la
                    gestión y el trato.
                  </p>
                  <textarea
                    value={comments}
        ...
        {currentView === 'success' && (
          <div className="animate-fade-in max-w-2xl mx-auto text-center py-16 bg-white rounded-2xl shadow-sm border border-slate-200 mt-10">
            ...
            <p className="text-slate-600 mb-8 px-6">
              Gracias por compartir tu experiencia. Tus respuestas han sido
              cifradas y registradas de forma completamente anónima. Este
              proceso es esencial para crear un entorno de trabajo mejor para
              todos.
            </p>
            <button
              onClick={() => setCurrentView('home')}
                ...
                <div>
                  ...
                  {adminError && (
                    <p className="text-red-500 text-sm mt-1">
                      Contraseña incorrecta. (Prueba con: auditor360)
                    </p>
                  )}
                </div>
                <button
          ...
          <div className="animate-fade-in">
            ...
            <div className="mb-8 border-b border-slate-200 flex space-x-8">
              <button
                ...
                className={`py-3 px-2 font-medium flex items-center gap-2 border-b-2 transition-colors ${
                  adminTab === 'resultados'
              ...
              <button
                onClick={() => {
                  setAdminTab('editar');
                  setLocalSurveyConfig(surveyConfig);
                }}
                className={`py-3 px-2 font-medium flex items-center gap-2 border-b-2 transition-colors ${
                  adminTab === 'editar'
                    ? 'border-blue-600 text-blue-600'
                ...
                <div className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
                  <div>
                    ...
                    <p className="text-slate-600 mt-1">
                      Análisis de la percepción, eficacia y clima laboral.
                    </p>
                  </div>
                ...
                {isLoadingStats ? (
                  ...
                  <div className="space-y-6">
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
                          ...
                          if (data.requiresSubRole) {
                            return data.subRoles.map((sr) => (
                              <button
                                key={`${key}_${sr.id}`}
                                onClick={() =>
                                  setAdminSelectedRole(`${key}_${sr.id}`)
                                }
                                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                                  adminSelectedRole === `${key}_${sr.id}`
                      ...
                      <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 p-1.5 rounded-lg w-full md:w-auto">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setAdminProfileFilter(e.target.value)
                          }
                    ...
                    {(() => {
                        ...
                        return (
                          <div className="bg-white p-12 rounded-xl border border-slate-200 text-center shadow-sm">
                            ...
                            <p className="text-slate-500">
                              No hay encuestas registradas que coincidan con la
                              búsqueda actual.
                            </p>
                          </div>
                        );
                      ...
                      if (stats.globalAverage >= 4.2)
                        diagnostico = {
                          texto: 'Excelencia / Liderazgo Sólido',
                          color: 'text-green-700',
                          bg: 'bg-green-100',
                        };
                      else if (stats.globalAverage >= 3.5)
                        diagnostico = {
                          texto: 'Aceptable / Con margen de mejora',
                          color: 'text-yellow-700',
                          bg: 'bg-yellow-100',
                        };
                      else if (stats.globalAverage > 0)
                        diagnostico = {
                          texto: 'Riesgo Institucional / Atención Urgente',
                          color: 'text-red-700',
                          bg: 'bg-red-100',
                        };
                      ...
                      return (
                        <div className="space-y-6">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                            <div
                              className={`p-4 rounded-xl border ${diagnostico.bg} border-opacity-50 flex flex-col justify-center`}
                            >
                              <p className="text-sm font-bold uppercase tracking-wider mb-1 opacity-70">
                                Diagnóstico Global
                              </p>
                              <p
                                className={`text-lg font-bold ${diagnostico.color}`}
                              >
                                {diagnostico.texto}
                              </p>
                            </div>
                            <div className="p-4 rounded-xl border bg-blue-50 border-blue-100 flex flex-col justify-center">
                              <p className="text-sm font-bold text-blue-800 uppercase tracking-wider mb-1 opacity-70">
                                Fortaleza Principal
                              </p>
                              <p className="text-md font-bold text-blue-900 leading-tight">
                                {stats.highestSection?.name || '-'}
                              </p>
                              <p className="text-sm text-blue-700 mt-1 font-medium">
                                Nota:{' '}
                                {stats.highestSection?.average
                                  ? stats.highestSection.average.toFixed(2)
                                  : '-'}{' '}
                                / 5
                              </p>
                            </div>
                            <div className="p-4 rounded-xl border bg-orange-50 border-orange-100 flex flex-col justify-center">
                              <p className="text-sm font-bold text-orange-800 uppercase tracking-wider mb-1 opacity-70">
                                Área de Mejora Prioritaria
                              </p>
                              <p className="text-md font-bold text-orange-900 leading-tight">
                                {stats.lowestSection?.name || '-'}
                              </p>
                              <p className="text-sm text-orange-700 mt-1 font-medium">
                                Nota:{' '}
                                {stats.lowestSection?.average
                                  ? stats.lowestSection.average.toFixed(2)
                                  : '-'}{' '}
                                / 5
                              </p>
                            </div>
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <div className="lg:col-span-1 space-y-6">
                              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm text-center">
                                ...
                                <div className="flex items-center justify-center gap-1 text-yellow-400 mb-3">
                                  {[1, 2, 3, 4, 5].map((star) => (
                                    <Star
                                      key={star}
                                      className={`w-5 h-5 ${
                                        Math.round(stats.globalAverage) >= star
                                          ? 'fill-current'
                                ...
                                <p className="text-sm text-slate-500">
                                  Muestra estadística:{' '}
                                  <b>{stats.totalEvaluations}</b> personas.
                                </p>
                              </div>
                              ...
                              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                                ...
                                <div className="space-y-3">
                                  {[5, 4, 3, 2, 1].map((score) => {
                                    const count =
                                      stats.scoreDistribution[score] || 0;
                                    const percentage =
                                      totalVotes > 0
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <div className="w-10 text-right text-slate-500 text-xs">
                                          {count} votos
                                        </div>
                                      </div>
                                    );
                            ...
                            <div className="lg:col-span-2 space-y-6">
                              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                                <h3 className="text-md font-bold text-slate-800 mb-6 border-b pb-2">
                                ...
                                {stats.comments.length === 0 ? (
                                  ...
                                  <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2">
                                    {stats.comments.map((comment, i) => (
                                      <div
                                        key={i}
                                        className="p-4 bg-slate-50 rounded-lg border border-slate-100 text-sm text-slate-700 italic relative"
                                      >
                                        <span className="absolute top-2 left-2 text-2xl text-slate-300 font-serif leading-none">
                                          "
                                        </span>
                                        ...
                                        <div className="text-xs text-blue-600 font-medium text-right mt-2 pt-2 border-t border-slate-200">
                                          Escrito por:{' '}
                                          {evaluatorProfiles.find(
                                            (p) => p.id === comment.profile
                                          )?.label || 'Perfil desconocido'}
                                        </div>
                                      </div>
                                    ))}
                                  </div>
              ...
              <div className="animate-fade-in pb-20">
                <div className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
                  <div>
                    ...
                    <p className="text-slate-600 mt-1">
                      Modifique, añada o elimine las preguntas que se mostrarán
                      en los formularios.
                    </p>
                  </div>
                  <button
                ...
                {configSaveStatus && (
                  <div
                    className={`mb-6 p-4 rounded-lg flex items-center gap-2 ${
                      configSaveStatus.includes('Error')
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                  <div className="flex overflow-x-auto border-b border-slate-200 bg-slate-50 p-2 gap-2">
                    {Object.entries(localSurveyConfig).map(
                      ([roleKey, roleData]) => {
                        const actualSelectedRole = adminSelectedRole.startsWith(
                          'director_pedagogico'
                        )
                          ? 'director_pedagogico'
                          : adminSelectedRole;
                        ...
                        return (
                          ...
                          >
                            {React.createElement(
                              iconMap[roleData.iconName] || ClipboardList,
                              { className: 'w-4 h-4' }
                            )}
                            {roleData.title}
                          </button>
                  ...
                  {(() => {
                    const roleKey = adminSelectedRole.startsWith(
                      'director_pedagogico'
                    )
                      ? 'director_pedagogico'
                      : adminSelectedRole;
                      ...
                      <div className="p-6">
                        <div className="mb-6 pb-4 border-b border-slate-200">
                          <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                            ...
                            Editando preguntas para: {roleData.title}
                          </h3>
                        </div>
                            ...
                            >
                              ...
                              <div className="space-y-4">
                                {section.questions.map((q, qIndex) => (
                                  <div
                                    key={q.id}
                                    className="flex gap-3 items-start bg-white p-4 rounded-lg border border-slate-100 shadow-sm group"
                                  >
                              ...
                              <button
                                onClick={() =>
                                  handleAddQuestion(roleKey, sIndex)
                                }
                              ...
                              >
                                <Plus className="w-4 h-4" /> Añadir Pregunta a
                                esta sección
                              </button>
                            </div>
                          ))}
